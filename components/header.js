...
import csi from '../public/assets/csilogo.png'
import ecell from '../public/assets/ectext.png'
import hello from '../public/assets/aces.png'
    ...
    <div className='flex justify-center '>
        ...
        <div className='header  lg:w-[75%] mt-2 lg:mt-5'>
            ...
            <div>
                ...
                <div className='hsmall text-white mt-2 lg:mt-4 font-extrabold ml-1 text-[max(1.1rem,min(2.5vw,2.7rem))]  flex items-center'><div>Powered by</div> <img src="../assets/aces.png" className='h-5  lg:h-10 ml-1 lg:ml-3' alt="" /></div>
            </div>
